<div class="row" id="small-boxes">
  ...
  <div class="col-12 col-sm-6 col-md-3" style="margin-top:10px;">
	<div class="info-box mb-3">
	  <span class="info-box-icon bg-danger elevation-1"><i class="fa fa-user-circle"></i></span>
  ...
  <div class="col-12 col-sm-6 col-md-3" style="margin-top:10px;">
	<div class="info-box mb-3">
	  ...
	  <div class="info-box-content">
		...
		<span class="info-box-number">
		<?php
				while($row =mysqli_fetch_assoc($departments_count)){
					echo number_format($row['departments']);
				}
			?> 
		</span>
	  </div>
  ...
  <div class="col-12 col-sm-6 col-md-3" style="margin-top:10px;">
	<div class="info-box mb-3">
	  <span class="info-box-icon bg-grey elevation-1"><i class="far fas fa-flag"></i></span>
