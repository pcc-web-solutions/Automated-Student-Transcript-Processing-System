...
$courses=$conn->query("SELECT DISTINCT(results_entry.course_code),courses.course_name,COUNT(DISTINCT results_entry.adm) AS total_trainees FROM results_entry INNER JOIN trainees ON trainees.course_code = results_entry.course_code INNER JOIN courses ON results_entry.course_code = courses.code WHERE trainees.status = '1' AND results_entry.term = '$term' AND results_entry.exam_year = '$year' GROUP BY courses.code ORDER BY courses.code");
?>
	...
	<body>
		<div class="card card-warning">
			<div class="card-header">
				<h4 class="card-title">COURSE TRANSCRIPTS</h4>	
			</div>
			<div class="card-body">
