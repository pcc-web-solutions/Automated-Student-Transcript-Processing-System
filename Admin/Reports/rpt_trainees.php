<?php
	...
	$course_codes = $conn->query("SELECT DISTINCT(trainees.course_code) AS code FROM trainees INNER JOIN courses ON courses.code = trainees.course_code WHERE trainees.status = '1' ORDER BY courses.code");
	...
	$pdf->Output('TRAINEES PER COURSE.pdf');
