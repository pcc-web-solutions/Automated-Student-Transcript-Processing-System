<?php
	...
	$pdf->SetTitle('Referlist Report');
	$pdf->SetSubject('Refered Trainees');
	...
	foreach($deptcodes as $dept)
	{
		...
		//PDF Report title
		$pdf->Ln();
		$pdf->WriteHTMLCell(193,5,'','','<h2 style="text-align: center;" ><u>REFER LIST</u></h2>',0);
		$pdf->Ln(5);
		...
		if($sql->num_rows>0){
			...
			while ($rows = $sql->fetch_array()) {
				...
				$passed = array("REFER", "FAIL", "C.R.N.M");
