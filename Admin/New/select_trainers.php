...
if(isset($_POST['selected_department'])){
	...
	$trainers = array();
	$select_trainer=$conn->query("SELECT trainer_id, first_name, last_name FROM trainers INNER JOIN departments ON departments.department_code = trainers.department_id WHERE departments.department_code='$selected_department' ORDER BY trainer_id");
