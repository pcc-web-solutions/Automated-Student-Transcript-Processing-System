...
<body>
            ...
            <?php  
             $classes=$conn->query("SELECT DISTINCT(classes.class_name), classes.class_id, classes.course_abrev, classes.academic_year, intakes.int_name, classes.status FROM classes INNER JOIN intakes ON classes.intake = intakes.int_abrev order by course_abrev ASC, academic_year DESC, intakes.int_name DESC, classes.class_name ASC");
