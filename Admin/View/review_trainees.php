...
require('../../Database/config.php');
	...
	$sql="SELECT * 	FROM trainees ORDER BY status DESC, course_code ASC, class DESC, adm ASC";
   ...
   <div id="mytable">
       <table class="table table-bordered table-striped text-nowrap" id=mytable>
            ...
            <tr>
                ...
                <td contenteditable="true" onfocus="changeBackground(this);" onblur="saveData(this, '<?php echo $row["sn"]; ?>', 'gender');"><?php echo strtoupper($row['gender']); ?></td>
