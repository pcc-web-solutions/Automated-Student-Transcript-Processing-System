...
{
	$insertdata = $conn->query("INSERT INTO classes (class_id, course_abrev, academic_year, intake, class_name, status) VALUES ('$classid','$course', '$year', '$intake', '$classname','Active')");
