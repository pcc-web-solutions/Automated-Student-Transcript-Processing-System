<?php
	...
	$get_courses = $conn->query("SELECT DISTINCT(courses.code), courses.course_name FROM courses INNER JOIN trainees ON trainees.course_code = courses.code WHERE courses.department_code = '$dept' AND trainees.status = '1' ORDER BY course_name ASC");
	...
	<div class="card card-info card-outline">
		...
		<div class="card-body">
			<div id="sheet_specification">
				<div class="row p-0">
					<div class="col-sm-4" class="custom-control custom-radio" style="margin-bottom: 10px;">
