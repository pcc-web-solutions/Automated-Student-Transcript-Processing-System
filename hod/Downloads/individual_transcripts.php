<?php
	...
	$selected_adms = $conn->query("SELECT distinct(results_entry.adm) as adm, trainees.name, trainees.class, term, exam_year from results_entry INNER JOIN trainees INNER JOIN courses ON courses.code = trainees.course_code ON trainees.adm = results_entry.adm where courses.department_code = '$dept' AND trainees.status = '1' and term='$term' and exam_year='$year' ORDER BY adm ASC");
	...
	<body>
		<div class="card card-warning">
			<div class="card-header">
				<h5  class="card-title">INDIVIDUAL TRANSCRIPTS</h5>
			</div>
			<div class="card-body">
