...
$sql="SELECT units.sn, units.unit_code, units.unit_name, units.courses_code, units.hourly_lessons, units.weekly_hours FROM units INNER JOIN courses ON courses.code = units.courses_code INNER JOIN departments ON departments.department_code = courses.department_code WHERE departments.department_code = '$dept' order by unit_code ASC, courses_code ASC";
