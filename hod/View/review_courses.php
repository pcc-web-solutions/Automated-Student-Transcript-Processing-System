...
require('../../Database/config.php');
	...
	$sql="SELECT * 	FROM courses  INNER JOIN departments ON departments.department_code = courses.department_code WHERE courses.department_code = '$dept' order by code ASC, course_name ASC";
