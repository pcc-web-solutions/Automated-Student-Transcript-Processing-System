...
<body>
    <div class="card card-success">
        ...
        <!-- /.modal -->
            <?php            
            $sql="SELECT * FROM users INNER JOIN trainers ON trainers.trainer_id = users.user_id INNER JOIN departments ON departments.department_code = trainers.department_id WHERE user_id != '$loggedin' AND usertype != 'Admin' AND usertype != 'HOD' AND departments.department_code = '$dept'"; 	
...
$(document).ready(function () {
	...
	$(this).parents('tr').remove(); 
        ...
        toastr.error("You don't have permission to delete this trainer.")
    })
