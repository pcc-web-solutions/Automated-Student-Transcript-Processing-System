...
<body>
	...
	<?php            
	$sql="SELECT * FROM trainers INNER JOIN departments ON trainers.department_id = departments.department_code WHERE departments.department_code = '$dept' ORDER BY trainer_id ASC"; 	
       ...
       <table class="table table-bordered table-striped text-nowrap" id=mytable>
		    <tr class="bg-info">
                ...
                <?php } else{?>
                    ...
                    <tbody id=records>
                        <tr>
							<td colspan=5 style="text-align: center;"><?php echo '<h6>There are no registered trainers<h6>'; ?></td>
                        </tr>
                    </tbody>
                </table>
