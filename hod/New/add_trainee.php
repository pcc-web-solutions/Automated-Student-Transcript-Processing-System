...
$courses = $conn->query("SELECT course_name, courses.code FROM courses INNER JOIN units ON units.courses_code = courses.code INNER JOIN classes ON classes.course_abrev = courses.course_abrev INNER JOIN departments ON departments.department_code = courses.department_code WHERE departments.department_code = '$dept' GROUP BY code ORDER BY course_name ASC");
?>
