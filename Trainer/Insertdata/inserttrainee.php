<?php
	...
	$check_adm = $conn->query("SELECT adm FROM trainees WHERE adm = '$adm'");
	$affectedrows = $check_adm->num_rows;
	...
	if($affectedrows==0){
		//echo "Trainee already registered";
			...
			$sql = "INSERT INTO trainees (adm,name,course_code,class,gender, added_by, deleted_by) 
		VALUES ('$adm','$name','$course','$class','$gender', '$trainer_id', '')";
			$sn = $db_handle->executeInsert($sql);
