                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-mb-6" style="margin-left: 15px; margin-right: 15px;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control form-control-sm" name="accstatus" value = <?php echo "'$accstatus'"; ?> readonly></input>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-5">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <input type="password" class="form-control form-control-sm" name="password" value = <?php echo $password; ?> ></input>
                                </div>
                            </div> 
                        </div>
                    </div>
