<?php
	...
	$courses = $conn->query("SELECT DISTINCT(trainer_units.course_code) AS code, course_name FROM trainer_units INNER JOIN courses ON courses.code = trainer_units.course_code WHERE trainer_id = '$trainer_id' GROUP BY courses.code ORDER BY courses.code, courses.course_name ASC ");
?>
...
<div class="card card-success card-outline">
   ...
   <div class="card-title text-muted">Trainee Registration Form</div>
...
$(document).ready(function(){
	...
	$('#batchregistration').click(function(){
			toastr.error("Sorry! this feature is currently unavailable");
	...
	$('#btnSaveAction').click(function(){
		...
		if(name == ""){
			...
			$.ajax({
				url: "Insertdata/inserttrainee.php",
				type: "POST",
