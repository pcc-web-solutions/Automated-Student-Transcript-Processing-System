<?php
	...
	// $select_courses = $conn->query("SELECT DISTINCT(code) AS course_code, course_name FROM courses INNER JOIN trainer_units ON trainer_units.course_code = courses.code WHERE trainer_units.trainer_id = '$trainer_id' ORDER BY code, course_name ASC");
...
<body>
	...
	<script type="text/javascript" src="review_marks_modal.js"></script>
</body>
</html>
