			...
			<form class="form-horizontal" id=dialog>
				<div class=row>
					<div class=col-sm-3 style="margin-bottom: 10px;">
						<label for="mark_entry_form">Course Title:</label>
