<?php
	...
	$courses = $conn->query("SELECT code, course_name FROM courses INNER JOIN trainer_units ON trainer_units.course_code = courses.code INNER JOIN trainees ON trainees.course_code = courses.code WHERE trainer_units.trainer_id = '$trainer_id' AND trainees.status = '1' GROUP BY courses.code ORDER BY code");
?>
<!DOCTYPE html>
<html>
<head>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('#close').click(function(e){
			if(confirm("Are you sure you sure you want to cancel this operation?")){
				location.reload()
			}
			else{
				e.preventDefault()
